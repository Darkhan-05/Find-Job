<div x-data="{ show: false }" @showerror.window="show = true; setTimeout(() => show = false,3000)" role="alert"
    class="fixed right-4 top-10 rounded border-s-4 border-red-500 bg-red-50 p-4 transform  transition-all duration-500 ease-in-out flex items-center justify-between"
