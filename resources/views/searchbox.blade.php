<div>
    <div
        ...
        <div class="flex items-center w-full gap-2 mb-3">
            ...
            <input name="search" placeholder="Search" class="w-full font-normal border-none rounded-lg"
                type="text" />
            <svg class="w-6 mr-3 text-[#ccc] hover:text-[#c1c1c1] icon" data-slot="icon" fill="none"
