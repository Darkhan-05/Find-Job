<div
    ...
    <div class="flex items-center w-full gap-2 mb-3">
        ...
        <input name="query" placeholder="{{ __('searchbox.searching for vacancies...') }}"
            class="w-full font-normal border-none rounded-lg" type="text" />
        <button
            class="h-full px-6 py-3 md:py-5 md:px-10 text-white cursor-pointer  bg-blueColor rounded-xl active:bg-blue-700 hover:bg-blue-600">
            {{ __('searchbox.search') }}
        </button>
    </div>
</div>
